...
# Parsing + Configuration Script – IMB-CS-CO2 - Rev. A

This **Parsing + Configuration** script is designed for the **IMB-CS-CO2** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – IMB-CS-CO2 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **IMB-CS-CO2** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
